...
"Profile": {
    ...
    "Background": {
        ...
        "High School": "Cane Ridge High School, Antioch, TN",
...
def SR_agent_response(player_info, existing_players):
    response = client.chat.completions.create(
        ...
        messages=[
            ...
            {"role": "user", "content": "Given the player's information, please generate a professional, authentic, and accurate scouting report for NBA draft prospects: " + json.dumps(player_info, indent=2)}
        ]
    )
